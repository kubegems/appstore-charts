...
{{- $presets := dict 
  ...
  "medium" (dict 
      "requests" (dict "cpu" "500m" "memory" "512Mi" "ephemeral-storage" "50Mi")
      "limits" (dict "cpu" "1" "memory" "2048Mi" "ephemeral-storage" "1024Mi")
   )
  "large" (dict 
      "requests" (dict "cpu" "500m" "memory" "512Mi" "ephemeral-storage" "50Mi")
      "limits" (dict "cpu" "2" "memory" "4096Mi" "ephemeral-storage" "1024Mi")
   )
  "xlarge" (dict 
      "requests" (dict "cpu" "1" "memory" "1024Mi" "ephemeral-storage" "50Mi")
      "limits" (dict "cpu" "4" "memory" "8192Mi" "ephemeral-storage" "1024Mi")
   )
  "2xlarge" (dict 
